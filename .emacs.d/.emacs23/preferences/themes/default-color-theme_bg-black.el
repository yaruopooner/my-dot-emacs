...
;;; last updated : 2012/04/16.16:57:58
...
;; カスタマイズテーマ名
(setq emacs-color-theme-name "BG-BaseColor-Black")


;;==============================================================================
;; User Color Condition                                                         
;; Frame Background カラーはブラック系であることが前提の設定                    
;;==============================================================================
...
(setq ect-frame-face-foreground-color                           "#ffffff")
(setq ect-frame-face-background-color                           "#000060")

;; ノーマルカーソルカラー
(setq ect-frame-face-cursor-color                               "yellow")
;; マウスカーソル表示色
...
(setq ect-frame-face-cursor-color-ime-off                       "yellow")
...
;; 選択範囲
(setq ect-general-face-fgc-region                               "black")
(setq ect-general-face-bgc-region                               "green")
...
;; 定数＆ラベル
(setq ect-cc-mode-face-fgc-constant                             "#00ff00")
...
;; 関数定義部分
(setq ect-cc-mode-face-fgc-function-name                        "#ffffff")
(setq ect-cc-mode-face-bgc-function-name                        nil)

;; 制御文＆識別子＆指定子＆型修飾子＆記憶クラス指定子
(setq ect-cc-mode-face-fgc-keyword                              "#bbbbff")
(setq ect-cc-mode-face-bgc-keyword                              nil)

;; 文字
(setq ect-cc-mode-face-fgc-negation-char                        "RosyBrown")
...
;; 正規表現
(setq ect-cc-mode-face-fgc-regexp-grouping-construct            "RosyBrown")
...
;; 文字列
(setq ect-cc-mode-face-fgc-string                               "RosyBrown")
(setq ect-cc-mode-face-bgc-string                               nil)

;; 型指定子＆構造体宣言部＆クラス
(setq ect-cc-mode-face-fgc-type                                 "#00b0ff")
...
;; プリプロセッサ
(setq ect-face-fgc-cc-mode_preprocessor                         "#ffff80")
...
(setq ect-face-fgc-cc-mode_structure                            "#bbbbff")
(setq ect-face-bgc-cc-mode_structure                            nil)

;; 型指定子
(setq ect-face-fgc-cc-mode_variable                             "#00b0ff")
...
(setq ect-face-fgc-cc-mode_type-specifier-0                     "#bbbbff")
(setq ect-face-bgc-cc-mode_type-specifier-0                     nil)

;; （型指定|型修飾）子
(setq ect-face-fgc-cc-mode_type-specifier-1                     "#00b0ff")
(setq ect-face-bgc-cc-mode_type-specifier-1                     nil)

;; 型修飾子
(setq ect-face-fgc-cc-mode_type-qualifier                       "#bbbbff")
...
(provide 'default-color-theme_bg-black)
;;==============================================================================
;; EOF
