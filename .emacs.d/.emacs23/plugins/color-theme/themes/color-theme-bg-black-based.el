...
(defun color-theme-bg-black-based ()
  "user default theme : background color is black based."
  (interactive)
  ...
  (let ((color-theme-legal-frame-parameters "\\(alpha\\|color\\|mode\\|left\\|top\\|width\\|height\\|font\\)"))
	...
	(border-color         . "red1" )
       ...
       ;; 選択範囲
       (region                                ((t   ( :foreground "black" :background "green1" :weight normal :slant normal ))))
       ...
       ;; 定数＆ラベル
       (font-lock-constant-face               ((t   ( :foreground "green1" :background nil :weight bold :slant normal :underline nil ))))
       ...
       ;; 関数定義部分
       (font-lock-function-name-face          ((t   ( :foreground "white" :background nil :weight bold :slant normal :underline nil ))))
       ;; 制御文＆識別子＆指定子＆型修飾子＆記憶クラス指定子
       (font-lock-keyword-face                ((t   ( :foreground "#bbbbff" :background nil :weight bold :slant normal :underline nil ))))
       ;; 文字
       (font-lock-negation-char-face          ((t   ( :foreground "RosyBrown" :background nil :weight bold :slant normal :underline nil ))))
       ...
       ;; 正規表現(Inherit > bold)
       (font-lock-regexp-grouping-construct   ((t   ( :foreground "RosyBrown" :background nil :weight bold :slant normal :underline nil ))))
       ...
       ;; 文字列
       (font-lock-string-face                 ((t   ( :foreground "RosyBrown" :background nil :weight bold :slant normal :underline nil ))))
       ;; 型指定子＆構造体宣言部＆クラス宣言部
       (font-lock-type-face                   ((t   ( :foreground "#00b0ff" :background nil :weight bold :slant normal :underline nil ))))
       ;; 変数名宣言部
       ...
       (semantic-highlight-func-current-tag-face          ((t   ( :foreground nil :background "gray20" :weight normal :slant normal :underline nil ))))
       ...
       ;; begin-------------------- plugin:navi --------------------
       (navi-file                             ((t   ( :foreground "green" :background unspecified :weight bold))))
       (navi-func                             ((t   ( :foreground "white" :background unspecified :weight bold))))
       (navi-mode                             ((t   ( :foreground "yellow" :background unspecified :weight bold))))
       ;; end---------------------- plugin:navi --------------------
       )
     )
    )
