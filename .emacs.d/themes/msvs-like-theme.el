(deftheme msvs-like "Microsoft Visual Studio like color theme")
...
(custom-theme-set-faces
 ...
 ;; '(default                              ((t ( :foreground "#ffffff" :background "#1e1e1e" ))))
 '(default                              ((t ( :foreground "#dadada" :background "#1e1e1e" ))))
 ;; ノーマルカーソルカラー
 '(cursor                               ((t ( :foreground nil :background "yellow1" ))))
 ;; マウスカーソル表示色
 ...
 ;; (cursor                                ((t   ( :foreground nil :background "yellow" :weight normal :slant normal ))))
 ;; (mouse                                 ((t   ( :foreground nil :background "MediumPurple" :weight normal :slant normal ))))
 ;; (border                                ((t   ( :foreground nil :background "#ff0000" :weight normal :slant normal ))))

 ;; フレーム左右の縁取りバー（hideshowvisや折り返し記号が表示される部分）
 '(fringe                               ((t ( :foreground unspecified :background "grey30" ))))

 ;; 選択範囲
 ;; '(region                               ((t ( :foreground "#dadada" :background "#264f78" :weight normal :slant normal ))))
 '(region                               ((t ( :foreground unspecified :background "#264f78" :weight normal :slant normal ))))

 ;; まわりのテキストに比べて、そのテキストを目立たなくします
 ;; 通常これはデフォルトの黒または白のフォアグラウンドカラーではなく、グレーが使われます
 ...
 '(header-line                          ((t ( :foreground "grey90" :background "grey20" :weight normal :slant normal :box unspecified :inherit mode-line ))))
 ...
 ;; begin-------------------- linum --------------------
 '(linum                                ((t (                 :background "gray20" :inherit (shadow default)))))
 ;; end---------------------- linum --------------------
 ...
 ;; 関数定義部分
 '(font-lock-function-name-face         ((t ( :foreground "white" :background nil :weight bold :slant normal :underline unspecified ))))
 ;; 制御文＆識別子＆指定子＆型修飾子＆記憶クラス指定子
 '(font-lock-keyword-face               ((t ( :foreground "#bbbbff" :background nil :weight bold :slant normal :underline unspecified ))))
 ;; 文字
 '(font-lock-negation-char-face         ((t ( :foreground "RosyBrown" :background nil :weight bold :slant normal :underline unspecified ))))
 ...
 ;; 正規表現(Inherit > bold)
 '(font-lock-regexp-grouping-construct  ((t ( :foreground "RosyBrown" :background nil :weight bold :slant normal :underline unspecified ))))
 ...
 '(semantic-highlight-func-current-tag-face         ((t ( :foreground nil :background "gray20" :weight normal :slant normal :underline unspecified ))))
 ...
 '(popup-scroll-bar-foreground-face     ((t ( :foreground nil :background "gray45" :weight normal :slant normal :underline unspecified ))))
 '(popup-scroll-bar-background-face     ((t ( :foreground nil :background "gray25" :weight normal :slant normal :underline unspecified ))))
 ...
 ;; バッファ内でhide状態のリージョン
 '(hs-face                              ((t ( :foreground "yellow" :background unspecified :weight bold :slant normal :box t ))))
