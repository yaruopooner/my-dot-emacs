(deftheme black-bg-based "Black background color theme")
...
(custom-theme-set-faces
 ...
 '(default                              ((t ( :foreground "#ffffff" :background "#000060" ))))
 ;; ノーマルカーソルカラー
 ...
 ;; begin-------------------- linum --------------------
 '(linum                                ((t (                 :background nil :inherit (shadow default)))))
 ;; end---------------------- linum --------------------
