...
;;; last updated : 2014/09/25.03:14:18
...
;; load path addition
;; (add-to-list 'load-path (expand-file-name "auto-complete/" de:path-plugins))
...
;; 補完候補選択中にポップアップするTIPSウィンドウの最大表示幅(オーバーすると改行される)
(setq popup-tip-max-width 200)
